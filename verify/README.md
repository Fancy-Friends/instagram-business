...
| Registry | Package |
|---|---|
| npm | `@particle-academy/instagram-business-js` (+ `@particle-academy/instagram-business-ui`, resolved transitively) |
...
npm install @particle-academy/instagram-business-js @particle-academy/fancy-flow
