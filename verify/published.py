"""
Instagram for Business — the published PyPI wheel.
...
def main() -> None:
    ...
    declared = requires("fancy-instagram-business")
    ...
    for golden in GOLDENS:
        ...
        fake = FakeValues(seed_for_call("instagram_business", operation, config))
