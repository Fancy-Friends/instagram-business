 ...
 */
/**
 * Every Instagram for Business node executor — the PHP twin of
 * `INSTAGRAM_BUSINESS_RUNNABLE_KINDS` in
 * @particle-academy/instagram-business-js.
 *
 * Each class declares its kind in a `#[FlowNode]` attribute. Two ways onto a
 * host:
 *
 * - `InstagramBusinessFlow::register($kinds, $executors)` — one call, no
 * directory scan.
 ...
 */
final class InstagramBusinessFlow
{
    /** @var list<class-string> */
    public const EXECUTORS = [
        MediaContainerExecutor::class,
        MediaPublishExecutor::class,
    ];
