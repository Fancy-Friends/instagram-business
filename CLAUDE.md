# AGENTS.md — Instagram for Business
...
npm run provider -- instagram-business            # regenerate this repo
npm run provider -- instagram-business --check    # exit 1 on any difference
```
...
| `packages/ui` | `@particle-academy/instagram-business-ui` — the authoring surface, React, every host | Generated |
| `packages/js` | `@particle-academy/instagram-business-js` — Node, on `@particle-academy/fancy-connector-core` | Generated |
| `packages/php` | `particle-academy/instagram-business-php` — PHP 8.4, on `particle-academy/fancy-connector-core` | Generated |
| `packages/py` | `fancy-instagram-business` — Python 3.11+, stdlib only | Generated |

The authoritative copy of `provider/` lives in the weaver envelope at
`providers/instagram-business/provider/`. The copy here is emitted from it and `--check`
...
| | Namespace |
|---|---|
| This repo | `github.com/Fancy-Friends/instagram-business` |
| npm | `@particle-academy/instagram-business-ui`, `@particle-academy/instagram-business-js` |
| Packagist | `particle-academy/instagram-business-php` |
| PyPI | `fancy-instagram-business` |
...
**Default to plain HTTP.** A Instagram for Business SDK is third-party code and is subject to
